...
const Home = () => {
  ...
  const typewriterInit = useCallback((typewriter) => {
    typewriter
      .pauseFor(500)
      .typeString("Oliver")
      .pauseFor(3000)
      ...
      >
        <section className="left-section">
          ...
          <div className="socials-btn-w">
            ...
            <a
              href={"https://twitter.com/Oliver1129"}
              aria-label="Twitter"
              target="_blank"
            >
            ...
            <a
              href={"https://www.instagram.com/oliverm11_/"}
        ...
        <section className="right-section">
          <LazyLoadImage
            src={"/assets/portrait/portrait2.webp"}
          ...
          <div className="service-card">
            ...
            <LazyMotion features={domAnimation}>
              ...
              >
                ...
                <br />
                in building and maintaining high-quality
                <br />
      ...
      <div ref={middleSection} className="middle-section">
        ...
        >
          <div className="about-content">
            <h2> Statement </h2>
            <p>
              With a relentless focus on creating simple and intuitive user
              experiences, my work always puts the consumer at the forefront. I
              firmly believe in the power of technology to simplify lives and
              make complex processes seamless. This conviction drives me to
              continually hone my skills, stay abreast of emerging technologies,
              and create innovative solutions. In every role, I bring my
              dedication to clear communication, problem-solving, and service.
              Helping others, whether it's my team, stakeholders, or the end
              users of the products I work on, is always a top priority. Ready
              to bring my skills and passion to new challenges. Let's connect
              and explore how we can build the future together.
              <Link to={"/contact"}>
          ...
          <div className="about-image-w">
            <section>
              <LazyLoadImage
                src={"/assets/portrait/portrait3.webp"}
            ...
            <section className="summary-section">
              <fieldset>
                <p>
                  Hello there! I'm a dedicated Full Stack Web Developer and
                  Software Engineer with a Bachelor of Technology in Computer
                  Information Systems from the City University of New York, New
                  York City College of Technology. Over the past three years,
                  I've gained extensive experience in building, optimizing, and
                  maintaining web applications using cutting-edge technologies.
                  <Link to={"/about"}>
        ...
        <section className="skills-section">
          ...
          <ul>
            <li>
              Languages & Libraries: C/C++, C#, Java, Python, HTML, CSS,
              JavaScript, Express.js, Mongoose.js, Node.js, React.js, Redux.js,
              JWT, Git, TypeScript
            </li>
            <li>
              Frameworks: Next.js, React-Router, Bootstrap, Tailwind, SCSS
            </li>
            <li>
              Databases & Tools: MongoDB, SQL/MySQL Workbench, Strapi CMS, EJS,
              Figma, GitHub, WordPress, RESTful API
            </li>
            <li>
              Applications & Cloud Platform: NetBeans, Visual Studio
              Code/Studio, Code::Blocks, Eclipse, Office, Teams, Azure, IBM, Any
              Desk, TeamViewer
            </li>
            <li>
              OS & Virtualizations: Windows 7, 8, 10, 11; Windows Server
              2012/2019, Mac OS, IOS, Android, Virtual Box, VMware, Hyper-V
            </li>
          </ul>
        </section>
      </div>
