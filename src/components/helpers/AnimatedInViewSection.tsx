...
export interface AnimatedInViewSectionProps
...
const defaultProps: Partial<AnimatedInViewSectionProps & MotionProps> = {
  delay: 0,
  duration: 0.3,
  animateX: 0,
  animateY: 0,
...
const AnimatedInViewSection = forwardRef<
  HTMLDivElement,
  AnimatedInViewSectionProps & MotionProps
>(
  (
    {
...
AnimatedInViewSection.displayName = "AnimatedInViewSection";

export default memo(AnimatedInViewSection);
