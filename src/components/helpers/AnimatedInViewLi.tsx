...
const defaultProps: Partial<AnimatedInViewLiProps & MotionProps> = {
  delay: 0,
  duration: 0.3,
  animateX: 0,
  animateY: 0,
...
const AnimatedInViewLi = forwardRef<
  HTMLLIElement,
  AnimatedInViewLiProps & MotionProps
>(
  (
    {
...
AnimatedInViewLi.displayName = "AnimatedInViewLi";

export default memo(AnimatedInViewLi);
