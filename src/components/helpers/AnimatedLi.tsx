...
export interface AnimatedLiProps extends ComponentPropsWithoutRef<"li"> {
  delay?: number;
  duration?: number;
...
const defaultProps: Partial<AnimatedLiProps & MotionProps> = {
  delay: 0,
  duration: 0.3,
  animateX: 0,
  animateY: 0,
...
const AnimatedLi = forwardRef<HTMLLIElement, AnimatedLiProps & MotionProps>(
  (
    {
...
AnimatedLi.displayName = "AnimatedLi";

export default memo(AnimatedLi);