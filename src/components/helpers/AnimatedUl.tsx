...
const defaultProps: Partial<AnimatedUlProps & MotionProps> = {
  delay: 0,
  duration: 0.3,
  animateX: 0,
  animateY: 0,
...
const AnimatedUl = forwardRef<HTMLUListElement, AnimatedUlProps & MotionProps>(
  (
    {
...
AnimatedUl.displayName = "AnimatedUl";

export default memo(AnimatedUl);