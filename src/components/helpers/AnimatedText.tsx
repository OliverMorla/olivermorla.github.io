...
export interface AnimatedTextProps extends ComponentPropsWithoutRef<"p"> {
  delay?: number;
  duration?: number;
...
const defaultProps: Partial<AnimatedTextProps & MotionProps> = {
  delay: 0,
  duration: 0.3,
  animateX: 0,
  animateY: 0,
