...
export interface AnimatedInViewTextProps extends ComponentPropsWithoutRef<"p"> {
  delay?: number;
  duration?: number;
...
const defaultProps: Partial<AnimatedInViewTextProps & MotionProps> = {
  delay: 0,
  duration: 0.3,
  animateX: 0,
  animateY: 0,
...
const AnimatedInViewText = forwardRef<
  HTMLParagraphElement,
  AnimatedInViewTextProps & MotionProps
>(
  (
    {
...
AnimatedInViewText.displayName = "AnimatedInViewText";

export default memo(AnimatedInViewText);
