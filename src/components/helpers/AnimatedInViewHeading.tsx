...
export interface AnimatedInViewHeadingProps
...
const defaultProps: Partial<AnimatedInViewHeadingProps & MotionProps> = {
  delay: 0,
  duration: 0.3,
  animateX: 0,
  animateY: 0,
...
const AnimatedInViewHeading = forwardRef<
  HTMLHeadingElement,
  AnimatedInViewHeadingProps & MotionProps
>(
  (
    {
...
AnimatedInViewHeading.displayName = "AnimatedInViewHeading";

export default memo(AnimatedInViewHeading);
