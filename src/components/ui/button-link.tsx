  ...
  "relative inline-flex items-center justify-center gap-2 whitespace-nowrap transition ease-in-out text-nowrap cursor-pointer select-none outline-none focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring/50 focus-visible:ring-[3px] disabled:pointer-events-none disabled:opacity-50 disabled:shadow-sm disabled:hover:shadow-none aria-invalid:border-red-500 aria-invalid:ring-red-500/20 dark:aria-invalid:ring-red-800/40",
  {
    variants: {
      variant: {
        ...
        gradient: 
          "text-white bg-gradient-to-r from-indigo-400 to-violet-400 hover:bg-gradient-to-r hover:from-indigo-500 hover:to-violet-500 active:bg-gradient-to-r active:from-indigo-600 active:to-violet-600 shadow-sm rounded-md",
        solid:
          "bg-indigo-200 hover:bg-indigo-300 active:bg-indigo-400 text-neutral-900 shadow-sm rounded-md",
        solidLight:
        ...
        info: "bg-blue-600 text-white hover:bg-blue-700 active:bg-blue-800 rounded-md shadow-sm border border-neutral-300/75 dark:border-neutral-700/7",
        disabled:
